...
**Table 2 — One pattern, every layer of the stack.**  (§3)
...
**Figure 3 — Distributed computing is a collective-action problem, not a hardware limit.**  (§4)
...
**Figure 4 — Machine demand has no floor.**  (§4)
...
*Beat: the questions are under active attack, and the breadth of the program is itself evidence of the §6 multiplier.* — **status report, self-reported**; states verified against the repos at the time of writing.
