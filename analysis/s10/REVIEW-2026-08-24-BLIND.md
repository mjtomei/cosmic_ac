...
- **[minor] [cohort+class]** 4.6a, 'Cohort towers over all of it': "Birth decade is **+1.01 (t = 10.96)** in the member-year panel with year fixed effects — t..." — *closed during the APC integration (2026-08-26): the citable figure requoted from the current 22-chamber panel run, +0.915 (t 12.54), verified against panel_estimation.py --arm class directly; the sentence also now scopes the term as the identified cohort-age combination per the new identification passage*
