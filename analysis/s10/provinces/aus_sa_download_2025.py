...
Reads aus_sa_manifest_2025.json, writes into aus_sa_raw/, logs aus_sa_download_2025.log.
...
def main():
    rows = json.load(open(HERE / "aus_sa_manifest_2025.json"))
    raw = HERE / "aus_sa_raw"
    raw.mkdir(exist_ok=True)
    log = open(HERE / "aus_sa_download_2025.log", "a")
    done = fail = skip = 0
