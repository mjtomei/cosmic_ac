...
takes it a step further: the content is scored from O*NET\textquotesingle s descriptors of
...
\textbf{What the measure is, and is not.} Against the market-fitted scales it is
...
complete: entered beside the study\textquotesingle s covariates, ISEI and wage collapse while
...
\textbf{The outcome.} The dependent variable throughout Part A is the register
instrument of Part B (\cref{sec:freq-descriptive}): a member\textquotesingle s rate of occurrence, per 100k words,
...
contrasts once entered beside them (\cref{sec:occupation}, \cref{sec:four-predictors}). The birth-year gradient of
