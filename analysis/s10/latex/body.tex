...
\bottomrule\noalign{}
\endlastfoot
\textbf{cohort} (per decade) & +0.276 (t 27.7) & \textbf{+0.270 (t 26.9)} \\
\textbf{class} (block Wald) & \textbf{p \textless{} 10⁻⁴} & \textbf{p \textless{} 10⁻⁴} \\
· II over I & +0.122 (t 3.63) & +0.072 (t 2.10) \\
· VIIab & −0.384 (t −3.70) & −0.299 (t −2.80) \\
\textbf{education} (block Wald) & p \textless{} 10⁻⁴ & \textbf{p = 0.215} \\
\textbf{prominence} (linear, \emph{not} the right form --- see D.3) & +0.037 (t 3.59) & −0.017 (t −0.46) \\
\end{longtable}
\endgroup
