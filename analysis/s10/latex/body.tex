...
\textbf{The claim.} The legislative register --- a member\textquotesingle s rate of use of the
vocabulary language models overuse, defined in \cref{sec:member-spec} --- peaks at the insulated
