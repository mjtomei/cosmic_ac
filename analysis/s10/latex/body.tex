...
\subsection{Estimate-specific audits}\label{sec:prevalence-audits}
...
\subsection{Word mix: the effects live in rate, not vocabulary --- and machine text sits outside the geometry}\label{sub:wordmix}
...
\subsection{Applicability: less to engage with}\label{sec:applicability}
...
\subsection{Evasion rewriting does not measurably change deliberative quality}\label{sec:evasion-quality}
