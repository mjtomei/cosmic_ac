...
\textbf{The coded ladder} (the measure\textquotesingle s primary form). Eighteen blind coding
passes nominated, multi-label, the elements that mark the \textbf{free / bottom /
...
\textbf{The directional ladder} (the semi-independent check). Three independent
blind coding workflows assigned elements to four accountability
components --- \textbf{U} upward (advising without the final say, discretion
...
The coded ladder\textquotesingle s consensus signature (\cref{sec:occ-classification}): every O*NET element, its
...
\caption{The coded ladder's consensus element signature: 85 elements over four levels, with consensus sign and coder count.}\label{tab:elements-levels}\\
\toprule\noalign{}
...
The directional ladder\textquotesingle s component assignments (three blind workflows;
consensus elements only):

\begingroup\small
\begin{longtable}[]{@{}p{0.36\linewidth}p{0.15\linewidth}p{0.15\linewidth}cr@{}}
\caption{The directional ladder's component assignments: 71 consensus elements over U/L/D/N.}\label{tab:elements-components}\\
\toprule\noalign{}
