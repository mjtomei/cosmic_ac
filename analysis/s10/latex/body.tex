...
9.4\% against 5.8\% for the shortest (review item X12).\footnote{Parenthetical codes like (review item X12) index findings
  ...
  note in the Supplementary materials.} Segment-weighting would
...
against an estimate from a different set of members): †\footnote{\texttt{python\ joint\_\allowbreak{}predictors.\allowbreak{}py}. Canonical member-level spec --- one
...
contributes more than a few thousandths.\footnote{\texttt{python\ prereg\_\allowbreak{}covariate\_\allowbreak{}strength.\allowbreak{}py} and \texttt{python\ prereg\_\allowbreak{}indoors\_\allowbreak{}joint.\allowbreak{}py} (n = 3,594, the full-covariate member panel):
  ...
  0.0007, EGP 0.0006, prominence 0.0005, education 0.0003.} So this is not a
...
higher-status parents once they become common.\footnote{\texttt{python\ class\_\allowbreak{}markedness.\allowbreak{}py}, \texttt{build\_\allowbreak{}class\_\allowbreak{}word\_\allowbreak{}year.\allowbreak{}py}. An earlier
...
+0.0099, positive in 9 of 10 cells, permutation p = 0.017.} †\footnote{\texttt{python\ word\_\allowbreak{}context\_\allowbreak{}delta.\allowbreak{}py\ pooled}, which prints the pooled figure,
