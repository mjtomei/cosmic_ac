...
tokens (\textasciitilde\(2\times\) all-in)} with no loss. (\texttt{opus\_effort\_ab.py}, \texttt{opus\_effort\_ab.csv})
...
(\(\geq\)25 members), member-level means over 22 chambers, z-scored within
chamber \(\times\) period so the overall era rise is removed and only the shape across
...
are \(\pm\)1 se. Class III remains thin (26--81 members) and its late excursion is not
...
of \(+0.065\sigma\) per rung --- but only by excluding the professional degree as off
the ladder, the one category that breaks monotonicity. The block is jointly significant on its own
(Wald \(p < 10^{-4}\) as level dummies).
...
--- block Wald (1 df) & & \(p < 10^{-70}\) & \(p < 10^{-68}\) & \(p < 10^{-59}\) & \\
\textbf{class} (baseline I, \emph{n} 1,660) & & & & & \\
\(\cdot\) II lower service & 1,691 & +0.122 (3.63) & \textbf{+0.080 (2.33)} & +0.017 (0.39) & +3 \\
\(\cdot\) III routine non-manual & 116 & +0.084 (0.95) & +0.029 (0.34) & +0.021 (0.19) & --- \\
\(\cdot\) IVab petty bourgeoisie & 280 & +0.005 (0.08) & \(-0.006\) (\(-0.10\)) & +0.007 (0.09) & --- \\
\(\cdot\) IVc farmers & 109 & \(-0.339\) (\(-3.48\)) & \textbf{\(-0.209\) (\(-2.19\))} & \(-0.090\) (\(-0.76\)) & \(-8\) \\
\(\cdot\) V/VI skilled manual & 130 & \(-0.229\) (\(-2.79\)) & \textbf{\(-0.244\) (\(-3.14\))} & \(-0.209\) (\(-1.95\)) & \(-9\) \\
\(\cdot\) VIIab non-skilled manual & 70 & \(-0.384\) (\(-3.70\)) & \textbf{\(-0.301\) (\(-2.76\))} & \(-0.041\) (\(-0.26\)) & \(-11\) \\
--- block Wald (6 df) & & \(p < 10^{-4}\) & \textbf{\(p < 10^{-4}\)} & \textbf{p = 0.55} & \\
\textbf{education} (baseline bachelor, \emph{n} 1,190) & & & & & \\
\(\cdot\) secondary & 231 & \(-0.315\) (\(-4.57\)) & \(-0.046\) (\(-0.73\)) & \(-0.045\) (\(-0.67\)) & --- \\
\(\cdot\) college & 367 & \(-0.204\) (\(-3.61\)) & \(-0.059\) (\(-1.11\)) & \(-0.086\) (\(-1.50\)) & --- \\
\(\cdot\) graduate & 1,266 & \(-0.063\) (\(-1.62\)) & \(-0.020\) (\(-0.55\)) & \(-0.017\) (\(-0.44\)) & --- \\
\(\cdot\) professional & 988 & \(-0.171\) (\(-4.05\)) & \(-0.090\) (\(-2.04\)) & \(-0.095\) (\(-1.96\)) & --- \\
--- block Wald (4 df) & & \(p < 10^{-4}\) & \textbf{p = 0.28} & p = 0.23 & \\
\textbf{prominence} (article-length quintile, baseline Q1) & & & & & \\
\(\cdot\) Q2 & 812 & \(-0.018\) (\(-0.37\)) & \(-0.069\) (\(-1.62\)) & \(-0.059\) (\(-1.32\)) & --- \\
\(\cdot\) Q3 & 812 & +0.228 (4.68) & \textbf{+0.164 (3.74)} & +0.171 (3.65) & +6 \\
\(\cdot\) Q4 & 812 & +0.210 (4.39) & \textbf{+0.146 (3.25)} & +0.185 (3.84) & +5 \\
...
\(\cdot\) free & & \(-0.243\) (\(-4.80\)) & --- & \(-0.127\) (\(-1.25\)) & --- \\
\(\cdot\) bottom & & +0.084 (2.18) & --- & +0.082 (0.98) & --- \\
\(\cdot\) middle & & \(-0.136\) (\(-2.64\)) & --- & \(-0.169\) (\(-1.56\)) & --- \\
\(\cdot\) top & & +0.008 (0.21) & --- & +0.132 (2.13) & +5/sd \\
--- block Wald (4 df) & & \(p < 10^{-4}\) & --- & \textbf{p = 0.26} & \\
\textbf{coded ladder} (per sd, n 3,631) & & & & & \\
\(\cdot\) FREE & & \(-0.109\) (\(-4.70\)) & --- & \textbf{\(-0.090\) (\(-3.07\))} & \(-3\)/sd \\
\(\cdot\) BOTTOM & & +0.115 (3.21) & --- & \(-0.040\) (\(-0.62\)) & --- \\
\(\cdot\) MIDDLE & & \(-0.156\) (\(-1.35\)) & --- & +0.146 (0.70) & --- \\
\(\cdot\) TOP & & +0.356 (2.72) & --- & \(-0.163\) (\(-0.75\)) & --- \\
...
\(-0.005\) per half-decade, t \(-0.4\)).\footnote{\texttt{python\ class\_\allowbreak{}gap\_\allowbreak{}trend.\allowbreak{}py}, from \texttt{class\_\allowbreak{}by\_\allowbreak{}era\_\allowbreak{}grouped.\allowbreak{}csv} (the
  era figure\textquotesingle s own per-period means within chamber \(\times\) period z); the gap\textquotesingle s
...
separation is constant across thirty years (+0.152 \(\rightarrow\) +0.153, trend t \(-0.4\)). A cycle already in progress before our first frame would look
