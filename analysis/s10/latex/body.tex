...
(\(-0.05\)/\(-0.10\)/\(-0.19\)/\(-0.19\) across the same thresholds), the \textbf{bottom
chases}, differentially adopting exactly the words that became common
(+0.15/+0.28/+0.41/+0.29 --- the battery\textquotesingle s only positive series,
strengthening with volume), and \textbf{free work sits out of the game
entirely}, flat against the middle at every threshold
(\(-0.04\)/\(-0.00\)/+0.00/\(-0.01\)): neither chasing nor fleeing, which is what
sitting outside the hierarchy predicts --- its low register level (\cref{sec:occupation}) is
...
geometry, read from one instrument\textquotesingle s levels.
