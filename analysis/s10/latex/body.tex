...
model and the education block goes to \textbf{p = 0.28} while class holds at
...
jointly-significant effects into years of cohort: †\footnote{\texttt{python\ joint\_\allowbreak{}predictors.\allowbreak{}py}. Canonical member-level spec --- one
  ...
  table --- and every EGP category present enters as a dummy. Prominence quintiles are cut on each estimation sample\textquotesingle s log article
...
\bottomrule\noalign{}
\endlastfoot
\textbf{cohort} (per decade) & 4,056 & +0.276 (27.7) & \textbf{+0.271 (27.1)} & +0.265 (24.7) & \emph{the scale} \\
--- block Wald (1 df) & & p \textless{} 10⁻⁷⁰ & p \textless{} 10⁻⁶⁸ & p \textless{} 10⁻⁵⁹ & \\
\textbf{class} (baseline I, \emph{n} 1,660) & & & & & \\
· II lower service & 1,691 & +0.122 (3.63) & \textbf{+0.080 (2.33)} & +0.017 (0.39) & +3 \\
· III routine non-manual & 116 & +0.084 (0.95) & +0.029 (0.34) & +0.021 (0.19) & --- \\
· IVab petty bourgeoisie & 280 & +0.005 (0.08) & −0.006 (−0.10) & +0.007 (0.09) & --- \\
· IVc farmers & 109 & −0.339 (−3.48) & \textbf{−0.209 (−2.19)} & −0.090 (−0.76) & −8 \\
· V/VI skilled manual & 130 & −0.229 (−2.79) & \textbf{−0.244 (−3.14)} & −0.209 (−1.95) & −9 \\
· VIIab non-skilled manual & 70 & −0.384 (−3.70) & \textbf{−0.301 (−2.76)} & −0.041 (−0.26) & −11 \\
--- block Wald (6 df) & & p \textless{} 10⁻⁴ & \textbf{p \textless{} 10⁻⁴} & \textbf{p = 0.55} & \\
...
--- block Wald (4 df) & & p \textless{} 10⁻⁴ & \textbf{p = 0.28} & p = 0.23 & \\
\textbf{prominence} (article-length quintile, baseline Q1) & & & & & \\
· Q2 & 812 & −0.018 (−0.37) & −0.069 (−1.62) & −0.059 (−1.32) & --- \\
· Q3 & 812 & +0.228 (4.68) & \textbf{+0.164 (3.74)} & +0.171 (3.65) & +6 \\
· Q4 & 812 & +0.210 (4.39) & \textbf{+0.146 (3.25)} & +0.185 (3.84) & +5 \\
· Q5 & 812 & +0.131 (2.77) & \textbf{+0.145 (3.22)} & +0.164 (3.36) & +5 \\
--- block Wald (4 df) & & p \textless{} 10⁻⁴ & \textbf{p \textless{} 10⁻⁴} & \textbf{p \textless{} 10⁻⁴} & \\
...
--- block Wald (4 df) & & p \textless{} 10⁻⁴ & --- & \textbf{p = 0.26} & \\
\textbf{coded ladder} (per sd, n 3,631) & & & & & \\
· FREE & & −0.109 (−4.70) & --- & \textbf{−0.090 (−3.07)} & −3/sd \\
· BOTTOM & & +0.115 (3.21) & --- & −0.040 (−0.62) & --- \\
· MIDDLE & & −0.156 (−1.35) & --- & +0.146 (0.70) & --- \\
· TOP & & +0.356 (2.72) & --- & −0.163 (−0.75) & --- \\
--- block Wald (4 df) & & p \textless{} 10⁻⁴ & --- & \textbf{p = 0.0008} & \\
\textbf{Indoors} (per sd, n 3,631) & & +0.091 (5.88) & --- & +0.032 (1.48) & --- \\
--- block Wald (1 df) & & p \textless{} 10⁻⁴ & --- & p = 0.13 & \\
\end{longtable}
\endgroup

The + occupational column\textquotesingle s changes come from the blocks, not the thinner
...
survives everything at p \textless{} 10⁻⁴ in every column --- the hump sits inside the
...
\textbf{2×}. Everything below computes on the same two
final runs.
