...
joint model (\cref{sec:class}). Read as measurement, that is machine aggregation of
human experience outperforming market-derived aggregation at the market\textquotesingle s
...
(\cref{sec:future}, item 32): tie the register, and registers like it, to productivity
and success measures. If register intensity predicts real outcomes that
the market\textquotesingle s summaries miss, the point stands on measurement rather than
argument.
