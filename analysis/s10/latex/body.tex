...
against an estimate from a different set of members): †\footnote{\texttt{python\ joint\_\allowbreak{}predictors.\allowbreak{}py}. Canonical member-level spec --- one
  ...
  each block\textquotesingle s term vector. "Alone" is the block fitted by itself on the
...
\bottomrule\noalign{}
\endlastfoot
\textbf{cohort} (per decade) & 4,056 & +0.276 (t 27.7) & \textbf{+0.270 (t 26.9)} & +0.27σ per decade of birth \\
\textbf{class} (block Wald) & 4,056 & \textbf{p \textless{} 10⁻⁴} & \textbf{p \textless{} 10⁻⁴} & \\
· II over I & 1,691 & +0.122 (t 3.63) & +0.072 (t 2.10) & +0.07σ ≈ 3 years of cohort \\
· VIIab & 70 & −0.384 (t −3.70) & −0.299 (t −2.80) & \textbf{−0.30σ ≈ 11 years of cohort} \\
\textbf{education} (block Wald) & 4,056 & p \textless{} 10⁻⁴ & \textbf{p = 0.215} & \\
\textbf{prominence} (linear, \emph{not} the right form --- see D.3) & 4,056 & +0.037 (t 3.59) & −0.017 (t −0.46) & --- \\
\end{longtable}
\endgroup

\textbf{Why the largest coefficient carries the least variance.} A term\textquotesingle s
...
smaller +0.122 on 42\% of members carries more (\textasciitilde0.36\%), and cohort\textquotesingle s
