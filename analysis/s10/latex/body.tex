...
\subsection{Calibration: 1,260 / 1,260}\label{sec:calibration}
...
\subsection{Prevalence: 9.0\% of words, with an elevenfold spread}\label{sec:prevalence}
...
\subsection{Genre: drafting concentrates in scripted business}\label{sec:genre}
...
Descriptive series (\cref{sec:freq-descriptive}), UK Commons extended back to 1985. The register
...
\subsection{A generational gradient, net of calendar drift}\label{sec:generational}
...
\subsubsection{Limits, and they are real}\label{sub:class-limits}
...
\subsection{What the class shape was: occupation, pre-registered and run}\label{sec:occupation}
...
relative contrast carry the claim; \cref{fig:altitude} plots both ladders.
...
Graded against the Discourse Quality Index \cite{steenbergen2003}, using the original authors\textquotesingle{} own codings of a 1998 UK Commons
