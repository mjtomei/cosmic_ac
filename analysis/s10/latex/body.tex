...
all seven half-decades (\cref{fig:class-era}), and the manual-and-farm tail sits at the floor in six
...
all (n \textless{} 25), and the rise is a single 55-member V/VI cell at +0.17 \(\pm\) 0.12,
one bin after that series\textquotesingle{} own minimum, with no preceding trend. It is
...
readable as movement; the pooled tail\textquotesingle s last-bin rise is a 55-member V/VI
wobble with farmers still at the floor and VIIab too thin to plot. (\texttt{python\ plot\_\allowbreak{}class\_\allowbreak{}by\_\allowbreak{}era\_\allowbreak{}grouped.\allowbreak{}py}, reading
