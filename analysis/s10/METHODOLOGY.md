...
*Sensitivity is not estimated. With specificity measured at 1 and any real
detector's sensitivity at most 1, the observed flag rate is a conservative
floor on true prevalence — no sensitivity figure is needed, and none is
reported.*
...
*Sensitivity is not estimated (see the calibration note above): prevalence is
reported as a floor, τ ≥ π, since Sp = 1 and Se ≤ 1. Nothing in the study
depends on a sensitivity number.*
