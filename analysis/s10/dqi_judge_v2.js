export const meta = {
  name: 'dqi-judge-v2-anchored',
  description: 'Anchored strict-DQI judging of 241 blinded segments with Fable 5 high',
  phases: [
    { title: 'Judge', detail: '25 batches, anchored DQI rubric' },
    { title: 'Reliability', detail: '60-segment second pass' },
  ],
}
...
const rel_batches = [
  ["S001","S007","S009","S021","S023","S027","S029","S031","S032","S037"],
  ["S039","S048","S059","S067","S070","S073","S074","S080","S082","S089"],
  ["S094","S098","S107","S109","S111","S116","S120","S124","S131","S132"],
  ["S134","S135","S140","S142","S144","S147","S151","S156","S161","S164"],
  ["S168","S170","S176","S177","S179","S180","S181","S183","S184","S185"],
  ["S187","S198","S206","S212","S224","S225","S226","S232","S233","S239"],
]
...
const rel = await parallel(rel_batches.map((b, i) => () =>
  agent(RUBRIC + b.join(', ') + `. Return all ${b.length} segments via structured output.`, {
    label: `rel2:${i}`, phase: 'Reliability', schema: SCHEMA, effort: 'high',
  }).then(r => r.scores)))

return {
  main: main.filter(Boolean).flat(),
  reliability: rel.filter(Boolean).flat(),
}