export const meta = {
  name: 'dqi-judge-v2b-years',
  description: 'Anchored strict-DQI judging of 220 per-year blinded segments with Fable 5 high',
  phases: [
...
const POOL = '/home/matt/performance_commons/analysis/s10/judge_blind_pool_t.json'

const ids = Array.from({length: 220}, (_, i) => 'T' + String(i).padStart(3, '0'))
const batches = []
