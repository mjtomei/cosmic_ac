export const meta = {
  name: 's10-gov-bypass-v3',
  description: 'Government Orders replication of the contrastive search: real human exemplars matched by score, noise-aware retirement, all sub-50 variants retained for a Pangram test',
  phases: [
...
const SEEDS = '/home/matt/performance_commons/analysis/s10/gov_seeds.json'
const CONTRAST = '/home/matt/performance_commons/analysis/s10/gov_contrast.json'
...
// state per text
const seedIdx = Array.from({length:35}, (_,i)=>i)
