...
| 2026-08-07 | **S10 sixteen-chamber panel built**: 8 Canadian provinces + 6 Australian states (203.6M words) + Scotland/Wales/NI, each from its own archive with a bespoke extractor and a mandatory validation report | The register's rise is **generational as well as period-wide** (birth-vs-spoken-year split, §4.6, `cohort_vs_period.py`): birth cohort predicts **+0.95 per 1,000 per decade (t 28)** net of calendar period, the stronger organiser in 10/13 chambers. Sitting members convert too — within-member (member FE) **+0.51 per decade (t 6.0)**, ~40% of the calendar drift — so both mechanisms operate. |
