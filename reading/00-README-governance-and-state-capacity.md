...
5. **~~The 1995 OTA closure appropriation line item.~~ LANDED 2026-08-06:** `leg-branch-approps-1996-ota-closure.pdf` — Pub. L. 104-53, 109 Stat. 514, govinfo publisher PDF, and the language is in the statute itself: "For salaries and expenses necessary to carry out the **orderly closure** of the Office of Technology Assessment, **$3,615,000**, of which $150,000 shall remain available until September 30, 1997," plus a 17-employee cap and Sec. 113 severance provisions. The created-and-withdrawn arc now has a primary source at BOTH ends. Also landed: `gao-staa-fact-sheet.pdf` (GAO-22-900426 — STAA at 129 staff by July 2022, the counsel-being-rebuilt datapoint) and Wildavsky as `wildavsky-1967-political-economy-efficiency-publicinterest.pdf` — NOTE: the author's *Public Interest* No. 8 (1967) republication carrying the full argument, not the *PAR* 26(4) 1966 original, which has no OA copy. **Schick 1973 definitively failed every OA route** (Unpaywall, ERIC, HathiTrust, archive.org, congressional reprints — the 1976 Senate print cites but does not reprint it); JSTOR-only, 10.2307/974211 — needs a browser with library access.
