...
| `00-README-user-modeling.md` | 33 | The model-human dyad: sycophancy and its mechanisms, demand inference, deployed-vs-available intelligence, honesty internals, role-play. Corpus of the pm project's user-model litreview (source docs live in the pm repo); the reciprocity mapping with the Kim personhood thread. | Empirics of LLM populations: convergent representations across architectures (Fu/Jia), diversity collapse within models (Banayeeanzade), and unreliable-but-measurable introspection (Lindsey). Serves both coherence and cosmic ac; seed. |
