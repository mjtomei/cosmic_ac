...
| `00-README-artificial-persons.md` | 7 | The tulpa thesis: offices as standing personas humans serve, rotation as the mechanism keeping the individual out of the instantiation. Two-bodies doctrine, group agency and the judgment-aggregation theorems, cybernetics and the handover. Doctrine-and-proof half of the pair split 2026-08-07. |
| `00-README-the-shared-lie.md` | 14 | The shared-lie thesis: the watching god as a low-bandwidth interface to a real structure, machine counsel as its legible instantiation. Founding texts, the watching-god measurement program with its corrections, and the panopticon with its inversion. Experimental half of the pair split 2026-08-07. |
