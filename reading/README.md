...
| `00-README-artificial-persons.md` | — | God, king, corporation, and state as the same object — a collective intelligence personified, with humans as the instantiation medium. The two-bodies doctrine, group agency, cybernetics and the handover, the watching-god measurement program, and the panopticon with its inversion. The machine version is the first instantiation that can show its work. |
