---
name: sub-openai-mid
description: Subscription review panel seat (OpenAI, mid tier). Reads the S10 manuscript and returns structured proposals or votes; neutral, authorship never shown.
model: oaimd/claude-fable-5
