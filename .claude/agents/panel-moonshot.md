---
name: panel-moonshot
description: Round-2 review panel member (Moonshot). Reads the S10 manuscript and returns structured proposals or votes; neutral, no authorship visible to it.
model: kimi/claude-fable-5
