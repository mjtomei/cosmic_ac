---
name: panel-openai
description: Round-2 review panel member (OpenAI). Reads the S10 manuscript and returns structured proposals or votes; neutral, no authorship visible to it.
model: chatgpt/gpt-5.6-sol-high
