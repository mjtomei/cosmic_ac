---
name: panel-google
description: Round-2 review panel member (Google). Reads the S10 manuscript and returns structured proposals or votes; neutral, no authorship visible to it.
model: gem/claude-fable-5
