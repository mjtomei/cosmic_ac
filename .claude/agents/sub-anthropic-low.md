---
name: sub-anthropic-low
description: Subscription review panel seat (Anthropic, low tier). Reads the S10 manuscript and returns structured proposals or votes; neutral, authorship never shown.
