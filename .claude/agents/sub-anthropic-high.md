---
name: sub-anthropic-high
description: Subscription review panel seat (Anthropic, high tier). Reads the S10 manuscript and returns structured proposals or votes; neutral, authorship never shown.
model: claude-opus-5
