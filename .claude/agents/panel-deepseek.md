---
name: panel-deepseek
description: Round-2 review panel member (DeepSeek). Reads the S10 manuscript and returns structured proposals or votes; neutral, no authorship visible to it.
model: ds/claude-fable-5
