---
name: sub-xai-mid
description: Subscription review panel seat (xAI, mid tier). Reads the S10 manuscript and returns structured proposals or votes; neutral, authorship never shown.
model: xmd/claude-fable-5
